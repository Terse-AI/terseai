# Terse SDK — Developer Reference

> **Note:** the `@terse-ai/sdk` npm package is not published to npm yet. Until it is, install from source by cloning this repo. For the Terse **app** and browser/editor extensions, see the [main README](README.md) and [terseai.org](https://www.terseai.org).
